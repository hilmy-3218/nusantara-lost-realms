        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="group relative inline-flex items-center justify-center w-full sm:w-auto px-9 py-4 overflow-hidden rounded-sm bg-[#0a0f0d] border border-[#d4af37]/40 shadow-[0_0_20px_rgba(212,175,55,0.15)] hover:shadow-[0_0_40px_rgba(212,175,55,0.6)] hover:border-[#ffd700] transition-all duration-500 cursor-pointer"
            >
